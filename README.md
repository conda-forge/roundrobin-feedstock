...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/roundrobin-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13547&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/roundrobin-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `roundrobin` can be installed with:

```
conda install roundrobin
```

It is possible to list all of the versions of `roundrobin` available on your platform with:
